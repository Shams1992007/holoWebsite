...
class OngoingRideAdmin extends React.Component {
  state = {
  ...
  handleRideClick = (rideId) => {
    ...
    axios
      .get(`https://api.holoapp.tech:3000/api/getOngoingRides/${rideId}`) // Replace with your API endpoint
      .then((response) => {
      ...
      <>
        ...
        <div className="ltn__page-details-area ltn__blog-details-area mb-120">
          <div className="container">
            <h1 className="text-center mb-4">Ongoing Rides</h1>
            {loading ? (
                ...
                <div className="col-md-10">
                  {rideDetail ? (
                    ...
                    <div className="text-center">
                      {selectedRideId
                        ? "This Ride is Completed, please go to completed rides page"
...
export default OngoingRideAdmin;