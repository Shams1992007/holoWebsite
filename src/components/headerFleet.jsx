      ...
      <div className="header-container">
        <div className="header-flex">
          ...
          <nav className="main-nav" aria-label="Main navigation">
            <Link to="/fleet-homepage" className="nav-link">
              Vehicle List
            </Link>
            <Link to="/rental-requests-fleet" className="nav-link">
              Rental Requests
            </Link>
            <Link to="/fleet-signin" className="nav-link">
              Logout
            </Link>
          </nav>
